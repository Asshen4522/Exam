...
__webpack_require__(/*! ./registerForm */ "./resources/js/registerForm.js");

__webpack_require__(/*! ./authorForm */ "./resources/js/authorForm.js");

/***/ }),

/***/ "./resources/js/authorForm.js":
/*!************************************!*\
  !*** ./resources/js/authorForm.js ***!
  \************************************/
/*! no static exports found */
...
var authorForm = document.forms['author']; // она не на всех страницах, так что проверка

if (authorForm) {
  var submitButton = authorForm.querySelector('.form__submit');
  submitButton.addEventListener('click', function (evt) {
    validate(authorForm);
    var inputs = Array.from(authorForm.querySelectorAll('.form__input'));
